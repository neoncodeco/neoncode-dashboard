export const queryKeys = {
  admin: {
    ...
    vpsLive: (serverId) => ["admin", "vps", "live", serverId || "all"],
    vpsHistory: (serverId, range) => ["admin", "vps", "history", serverId, range],
    vpsAlerts: (serverId) => ["admin", "vps", "alerts", serverId || "all"],
