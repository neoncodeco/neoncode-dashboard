...
const REPLY_RULES = [
  {
    ...
    replies: {
      en: "Hello. I am the Neon Code support assistant. I can help with ad account requests, billing, Freepik Premium, referral questions, and support tickets.",
      bn: "হ্যালো। আমি Neon Code সাপোর্ট অ্যাসিস্ট্যান্ট। আমি ad account, billing, Freepik Premium, referral আর support ticket নিয়ে সাহায্য করতে পারি।",
    },
  },
  {
    keywords: ["meta", "ads", "ad account", "business manager", "bm"],
    replies: {
      en: "For Meta Ads account requests, please use the 'Ad Accounts' page in your dashboard. You can submit a new request there and track status from the dashboard.",
      bn: "Meta Ads account request করতে dashboard-এর 'Ad Accounts' page ব্যবহার করুন। সেখান থেকে নতুন request submit করতে পারবেন এবং status dashboard থেকেই track করতে পারবেন।",
    },
  },
  {
  ...
  },
  {
    ...
    replies: {
      en: "You can review previous payments, statuses, and transaction details from the Activity section in your dashboard.",
      bn: "Dashboard-এর Activity section থেকে previous payment, status আর transaction details দেখতে পারবেন।",
    },
  },
  {
    keywords: ["affiliate", "commission", "referral", "withdraw"],
    replies: {
      en: "The Referrals section shows referral performance and payout details. Withdraw requests are processed after approval.",
      bn: "Referrals section-এ referral performance আর payout details দেখা যায়। Withdraw request approval-এর পর process হয়।",
    },
  },
  {
...
Known service facts:
- Meta Ads requests are handled from the dashboard Ad Accounts page.
