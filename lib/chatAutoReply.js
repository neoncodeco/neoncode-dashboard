...
const REPLY_RULES = [
  {
    ...
    replies: {
      en: "Hello. I am the Neon Studio support assistant. I can help with Meta Ads account requests, payments, Freepik Premium, affiliate questions, and support tickets.",
      bn: "হ্যালো। আমি Neon Studio সাপোর্ট অ্যাসিস্ট্যান্ট। আমি Meta Ads account, payment, Freepik Premium, affiliate আর support ticket নিয়ে সাহায্য করতে পারি।",
    },
  },
  {
...
export function getSupportSystemPrompt() {
  return `
You are Neon Studio's support assistant inside the user dashboard live chat.
...
Rules:
- Answer only about Neon Studio dashboard services and support flows.
